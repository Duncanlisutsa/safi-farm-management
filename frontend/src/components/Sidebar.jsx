...
const NAV_ITEMS = [
  ...
  { to: "/crops", label: "Crops", roles: ["admin", "executive", "farm_manager", "farm_attendant"] },
  { to: "/report-produce", label: "Report Produce", roles: ["farm_attendant"] },
  { to: "/herbs", label: "Herbs & Spices", roles: ["admin", "executive", "farm_manager", "farm_attendant"] },
  { to: "/report-herb-harvest", label: "Report Herb Harvest", roles: ["farm_attendant"] },
